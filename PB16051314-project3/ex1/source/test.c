...
static void _fib_heap_delete(FibHeap *heap, FibNode *node)
{
    ...
    printf("\nbegin fib_heap_decrease                ");
    fib_heap_decrease(heap, node, min-1);
    printf("end fib_heap_decrease                ");

    printf("\nbegin _fib_heap_extract_min                ");
    _fib_heap_extract_min(heap);
    printf("end _fib_heap_extract_min                ");
...
void fib_heap_delete(FibHeap *heap, Type key)
{
    ...
    if (node == NULL){
        printf("ERROR: fib_heap_delete 2");
        return ;
    }
...
//建堆
        ...
        printf("%d\n", n);
//        for (int i = 0; i < 10; i++) {
        fib_heap_insert_key(heap, 5);
        fib_heap_insert_key(heap, 5);
        fib_heap_insert_key(heap, 7);
//        }
...
//    FibHeap *heap;
//    heap = fib_heap_make();
//    fib_heap_insert_key(heap, 1);
//    fib_heap_insert_key(heap, 2);
//    fib_heap_insert_key(heap, 3);
//    fib_heap_insert_key(heap, 4);
//    fib_heap_insert_key(heap, 5);
//    fib_heap_insert_key(heap, 6);
//    fib_print(heap);
////    fib_heap_destroy(heap);
//
//    heap = fib_heap_make();
